module github.com/sowens-csd/ftlambdas/community/si

go 1.18

require (
	github.com/aws/aws-lambda-go v1.33.0
	github.com/sowens-csd/folktells-server v1.7.10
)
...
require (
	...
	github.com/aws/aws-sdk-go-v2/service/ssm v1.27.4 // indirect
